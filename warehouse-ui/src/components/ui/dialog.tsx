...
function DialogHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("-mx-6 -mt-6 flex flex-col gap-1 border-b px-6 pb-4 pt-5", className)}
      {...props}
    />
  )
}
...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-6 -mb-6 flex flex-col-reverse gap-2 rounded-b-xl border-t bg-muted/40 px-6 py-4 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    >
